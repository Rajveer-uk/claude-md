...
description: Use when structuring an Android or Kotlin Multiplatform project by Clean Architecture — module boundaries, dependency rules, UseCases, Repositories, and data-layer patterns.
metadata:
  origin: ECC
---
...
Clean Architecture patterns for Android and KMP: module boundaries, dependency inversion, UseCase/Repository patterns, and data layer design with Room, SQLDelight, and Ktor.
