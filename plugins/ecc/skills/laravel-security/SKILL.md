...
Security guidelines protecting Laravel applications against common vulnerabilities.
...
// Register the alias in bootstrap/app.php (Laravel 11/12 slim skeleton)
...
```php
// Laravel CSRF is enabled by default for the 'web' middleware group
// (Laravel 11/12 wires this in bootstrap/app.php — no app/Http/Kernel.php)
...
```php
// bootstrap/app.php (Laravel 11/12 slim skeleton)
->withMiddleware(function (Middleware $middleware) {
...
// Register globally in bootstrap/app.php (Laravel 11/12 slim skeleton)
->withMiddleware(function (Middleware $middleware) {
