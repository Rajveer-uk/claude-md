...
description: JetBrains Exposed ORM patterns including DSL queries, DAO pattern, transactions, HikariCP connection pooling, Flyway migrations, and repository pattern. Use when writing or reviewing Kotlin Exposed database code.
metadata:
  origin: ECC
---
