...
description: Use when altering schema or migrating data — safe, reversible changes, rollbacks, and zero-downtime deployments across PostgreSQL, MySQL, and common ORMs (Prisma, Drizzle, Kysely, Django, TypeORM, golang-migrate).
metadata:
  origin: ECC
---
