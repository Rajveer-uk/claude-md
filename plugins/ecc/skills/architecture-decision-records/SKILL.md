...
description: Use when an architectural decision is made or revisited — capture it as a structured ADR (context, alternatives, rationale) and maintain an ADR log so future developers understand why the codebase is shaped the way it is.
metadata:
  origin: ECC
---
