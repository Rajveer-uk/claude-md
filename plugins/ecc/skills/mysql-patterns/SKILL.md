---
name: mysql-patterns
description: MySQL and MariaDB schema, query, indexing, transaction, replication, and connection-pool patterns for production backends. Use when writing or reviewing MySQL/MariaDB code.
metadata:
  origin: ECC
---
...
- Agent: `database-expert` - broader database review workflow
