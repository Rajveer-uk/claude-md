...
- Run phases sequentially, environment checks through deployment readiness — each layer builds on the last.
- Environment and Composer checks gate everything else; stop immediately on failure.
- Linting/static analysis must be clean before full tests and coverage.
- Security and migration reviews come after tests — verify behavior before data or release steps.
