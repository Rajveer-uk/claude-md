...
| Skills directory | `ls ~/.claude/skills` where applicable | Say no local skill catalog was available |
...
For non-trivial functionality, launch a general-purpose research sub-agent:
