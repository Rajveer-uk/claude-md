...
description: Use when caching expensive file processing (PDF parsing, extraction, image analysis) — SHA-256 content-hash keys that are path-independent, auto-invalidating, with service-layer separation.
metadata:
  origin: ECC
---
