...
description: Use when securing a Django app — authentication, authorization, CSRF protection, SQL-injection and XSS prevention, and secure deployment configuration.
metadata:
  origin: ECC
---
