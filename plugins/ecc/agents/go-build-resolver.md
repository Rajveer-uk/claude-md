...
- Read the FIRST error first: later errors are usually cascade -- one bad import or type can fail every dependent package. Ask what single cause explains the most symptoms.
...
- Distinguish observed (the error text), inferred (your reading of it), and assumed (Go version, module state, build tags) -- verify any assumption the fix depends on.
